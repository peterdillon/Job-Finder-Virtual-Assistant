    ...
    return {
      ...
      compile: function(element, attr) {
        return function($scope, $element, $attr, swipeCards) {
          var el = $element[0];
          var leftText = el.querySelector('.remove-job');
          var rightText = el.querySelector('.save-job');
          ...
          var swipeableCard = new SwipeableCardView({
            ...
            onSnapBack: function(startX, startY, startRotation) {
              var leftText = el.querySelector('.save-job');
              var rightText = el.querySelector('.remove-job');
